% this function applies the additive logNormal noise to an image
% taking the following parameters 
% input_Image: a matrix of integers
function result_image = lognormalNoise(input_Image, a, b)
    ...
    % imnoise2.m file
    noise = imnoise2('lognormal', rows, cols, a, b);
    result = img + noise;
